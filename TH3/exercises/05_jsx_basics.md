...
*Lương Văn Hưng đã thấy "nỗi đau" khi dùng DOM thuần (Bài 0.0). Giờ bạn ấy muốn viết giao diện Portfolio bằng JSX — cú pháp mà React sử dụng. JSX trông giống HTML nhưng mạnh hơn rất nhiều: chèn được JavaScript, render danh sách, hiển thị có điều kiện.*
...
<body>
    <h1>🛠️ Dự án của Lương Văn Hưng</h1>
    <div id="root"></div>
