...
*Ở Bài 0.5, Lương Văn Hưng đã viết `PortfolioHero`, `ProjectCard`, `ProjectList` — nhưng tất cả code vẫn nằm trong một file HTML với CDN. Giờ bạn ấy muốn chuyển sang dự án thật với Vite + React. Trước khi tạo project, cần học cách **tách UI lớn thành component nhỏ, có tổ chức**.*
